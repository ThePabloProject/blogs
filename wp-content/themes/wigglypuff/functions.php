...
add_action('wp_ajax_nopriv_more_author_opinion', 'more_author_opinion'); 
add_action('wp_ajax_more_author_opinion', 'more_author_opinion');

//category page load more
   function more_category_post(){
    $offset = $_POST["offset"];
    $ppp = $_POST["ppp"];
	$cat_id= $_POST["cat_id"];
    header("Content-Type: text/html");
...
add_action('wp_ajax_nopriv_more_category_post', 'more_category_post'); 
add_action('wp_ajax_more_category_post', 'more_category_post');
